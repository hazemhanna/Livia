...
open class TextFieldDropDown : UITextField{
    ...
    func setupUI () {
        ...
        if isSearchEnable && handleKeyboard{
            NotificationCenter.default.addObserver(forName: UIWindow.keyboardWillShowNotification, object: nil, queue: nil) { (notification) in
            ...
            NotificationCenter.default.addObserver(forName: UIWindow.keyboardWillHideNotification, object: nil, queue: nil) { (notification) in
                if self.isFirstResponder{
...
extension TextFieldDropDown : UITextFieldDelegate {
...
extension TextFieldDropDown: UITableViewDataSource {
...
extension TextFieldDropDown: UITableViewDelegate {
