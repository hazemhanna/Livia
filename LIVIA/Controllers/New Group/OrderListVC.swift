...
class OrderListVC : UIViewController {
    ...
    let TypeArr = ["all order".localized,"new order".localized, "preparing order".localized , "on_way".localized, "arrived".localized, "completed".localized ,"canceled2".localized]
